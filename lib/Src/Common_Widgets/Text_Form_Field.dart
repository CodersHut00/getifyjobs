...
Widget textFormField(
    ...
    String? Function(String?)? validating,
     bool? isEnabled,
    void Function(String)? onChanged,required String hintText,Widget? prefixIcon,Widget? sufixIcon,List<TextInputFormatter>? inputFormatters,required TextInputType keyboardtype}) {
  return
    Container(
      // height: 50,
      child:
  ...
  return  Container(
    ...
    TextFormField(
      ...
      decoration: InputDecoration(
        ...
        prefixIcon: Icon(Icons.lock,color: grey2,),
        suffixIcon: IconButton(
          icon: Icon(obscure
              ? Icons.remove_red_eye_outlined
              : Icons.remove_red_eye_sharp,color: grey2,),
          onPressed: onPressed,
        ),
        fillColor: white1,
        filled: true,
...
//DESCRIPTION
Widget textfieldDescription({TextEditingController? Controller, String? Function(String?)? validating}){
  return Container(
    // height: 50,
    child: TextFormField(
      controller: Controller,
